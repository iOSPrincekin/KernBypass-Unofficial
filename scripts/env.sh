...
MOBILESUBSTRATE_DIR=${CONTROLCENTER_DIR}/MobileSubstrate/
DYNAMICLIBRARIES_DIR=${MOBILESUBSTRATE_DIR}/DynamicLibraries/


PREFERENCEBUNDLES_DIR=${CONTROLCENTER_DIR}/PreferenceBundles/
PREFERENCELOADER_DIR=${CONTROLCENTER_DIR}/PreferenceLoader/
